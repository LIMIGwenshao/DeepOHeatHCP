...
domain_0 = dict(
    ...
    conductivity_dist=dict(uneven_conductivity=False, background_conductivity=300),
    power=dict(bc=False),
...
domain_1 = dict(
    ...
    conductivity_dist=dict(uneven_conductivity=False, background_conductivity=100),
    power=dict(bc=False),
    # power=dict(
    #     bc=True,
...
domain_2 = dict(
    ...
    conductivity_dist=dict(uneven_conductivity=False, background_conductivity=200),
    power=dict(bc=False),
    # power=dict(
    #     bc=True,
    #     num_power_points_per_volume=2,
    ...
    power=dict(
        ...
        power_map=dict(
            power_0=dict(
                type="surface_power",
                surface="top",
                location=dict(starts=(0, 0, 2), ends=(2, 2, 2)),
                params=dict(k=0.2, value=1, weight=1),
            )
        ),
    ),
