...
dataset = dataio_deeponet.DeepONetMeshDataIO( #数据集包括几何参数、各种参数、以及训练模式和测试模式、画图
    domains_list, global_params, dim=3, var=var, len_scale=len_scale
...
root_path = "./log"
experiment_name = "3000(5batch)_volumetricPower_allAdiabatics_mesh3dim"
