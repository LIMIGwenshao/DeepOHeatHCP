...
os.chdir(dir_path)
sys.path.append("../../")
from src import dataio, training_debug, loss_fun, modules
...
domain_0 = dict(
    ...
    power=dict(
        bc=True,
        num_power_points_per_volume=4,#指的是网格点的间隔体积
...
domain_4 = dict(
    ...
    power=dict(
        ...
        power_map=dict(
            power_0=dict(
                type="volumetric_power",
                location=dict(starts=(0, 0, 2), ends=(10, 10, 3)),
                params=dict(k=0.2, value=1, weight=1),
            )
        ),
    ),
...
val_func = training_debug.val_fn_init(False)

root_path = "./log"
experiment_name = "6000_toppower_lhs"
