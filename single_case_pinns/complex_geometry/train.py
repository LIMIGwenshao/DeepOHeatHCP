...
domain_0 = dict(
    ...
    power=dict(
        bc=True,
        num_power_points_per_volume=4, #单位体积的功率点采样密度
        num_power_points_per_surface=500, #全局最大表面功率点数量
        num_power_points_per_cell=5, #局部表面功率点最小采样密度，防止局部区域功率采样点数过低，每个表面单元最少采样 5 个点。
        power_map=dict(
            power_0=dict(
...
root_path = "./log"
experiment_name = "test_configured"
