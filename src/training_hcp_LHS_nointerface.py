...
def train(
    ...
    for epoch in range(start_epoch, epochs):
        ...
        # Save the loss lists as .npy files
        np.save('NOinterface_lhs_total_loss_list.npy', total_loss_list)
        np.save('NOinterface_lhs_pde_loss_list.npy', pde_loss_list)
        np.save('NOinterface_lhs_htc_loss_list.npy', htc_loss_list)
        np.save('NOinterface_lhs_adiabatics_loss_list.npy', adiabatics_loss_list)
        np.save('NOinterface_lhs_volumetric_power_loss_list.npy', volumetric_powers_loss_list)
        np.save('NOinterface_lhs_surface_power_loss_list.npy', surface_powers_loss_list)
        np.save('NOinterface_lhs_neumanns_loss_list.npy', neumanns_loss_list)
        np.save('NOinterface_lhs_dirichlets_loss_list.npy', dirichelets_loss_list)
        np.save('NOinterface_lhs_interface_temperature_loss_list.npy', interface_temperature_loss_list)
        np.save('NOinterface_lhs_interface_convection_loss_list.npy', interface_convection_loss_list)
